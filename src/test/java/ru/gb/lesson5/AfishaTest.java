...
public class AfishaTest {
    ...
    void goToOkkoTest() throws InterruptedException {
        //*[contains(text(),'Ваш город')]/../..
        //div[@data-test='HONEY-AD AD-ad_1']
        //button[@id="fucking-privacy"]/../../../..
        //div[@id="popmechanic-container-40776"]
        //*[@id="popmechanic-form-49417"]/..
...
//        Thread.sleep(5000);
//        ((JavascriptExecutor) driver).executeScript(
//                "let element = document.evaluate(\"//*[@id=\"popmechanic-form-49417\"]/..\", document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null);\n" +
//                        "element.singleNodeValue.remove();"
//        );

        //a[.='КИНО']
        //li//a[.='Скоро онлайн в Okko']
